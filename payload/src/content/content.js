(function () {
  ...
  function installFigBoostMenuStyle() {
    ...
    style.textContent = [
      ...
      ".figboost-menu-wrap[data-placement='titlebar']{position:fixed;right:234px;top:8px;}",
      ".figboost-menu-button{box-sizing:border-box;width:20px;height:20px;margin:0;padding:0;border:0;border-radius:2px;background:transparent;color:#b6b6b6;display:flex;align-items:center;justify-content:center;cursor:pointer;}",
      ".figboost-menu-button:hover,.figboost-menu-button[aria-expanded='true']{background:#454545;color:#d6d6d6;}",
      ".figboost-menu-button:active{background:#4b4b4b;}",
