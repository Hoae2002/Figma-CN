(function () {
  ...
  function installFigBoostMenuStyle() {
    ...
    style.textContent = [
      ...
      ".figboost-menu-button{box-sizing:border-box;width:50px;height:37px;margin:0;padding:0;border:0;border-radius:0;background:transparent;color:#b6b6b6;display:flex;align-items:center;justify-content:center;cursor:pointer;}",
      ".figboost-menu-button:hover,.figboost-menu-button[aria-expanded='true']{background:#424242;color:#d6d6d6;}",
      ".figboost-menu-button:active{background:#474747;}",
